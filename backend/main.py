...
def get_user_transcript(audio_stream: bytes) -> speech.RecognizeResponse:
    ...
    config = speech.RecognitionConfig(
        ...
        audio_channel_count=audio_headers.get('channels'),  # 1 channel for raw, 2 channels for wav
        sample_rate_hertz=audio_headers.get('sample_rate'),  # 16000 for raw, 44100 for wav
        language_code="en-US",
    )
