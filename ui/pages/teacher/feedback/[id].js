...
export default function FeedbackPage() {
  ...
  // Fetch feedback data
  useEffect(() => {
    const feedbackUrl = `${BACKEND_URL_BASE}/post-conversation-info/${id}`;
    id &&
      fetch(feedbackUrl)
    ...
    <div className="glass-container">
      ...
      {Object.keys(conversationInfo).map((info, index) => {
        return (
          <div
            key={index}
            className=" w-full flex gap-1 mb-3 font-display text text-xl"
          >
...
function OverFeedBack(overallFeedback) {
  return (
    <div className="glass-container">
      <h2 className="header2">Overall Feedback</h2>
              ...
              {detail["role"] === "ai" ? (
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <p>
                    ...
                    {detail["synonyms"] && detail["synonyms"].join(", ")}
                  </p>
                  <p>
