...
export default function CreatePage() {
    ...
    const url3 = 'http://127.0.0.1:5000/get-friends/' + getCookie('email')
    ...
    const create = async (data) => {
        const url = "http://127.0.0.1:5000/create-conversation"
        try {
    ...
    return (
        // MAIN
        <div
            className="h-screen bg-art flex flex-col items-center justify-center"
        >
            <Head>
